        ...
        (function (a) {
            ...
            var b = {
                ...
                applyInputSuccessStyling: function (a, b) {
                    a.addClass("valid"),
                        this.getParentContainer(a).addClass(
                            b.inputParentClassOnSuccess
                        );
                },
                ...
                removeAllMessagesAndStyling: function (c, d) {
                    ...
                    c.find("." + d.errorElementClass + ",.valid").each(
                        function () {
                ...
                setInlineMessage: function (b, c, d) {
                    ...
                    var e,
                        f = document.getElementById(
                            b.attr("name") + "_err_msg"
                        ),
                        g = !1,
                        h = function (d) {
                            a.formUtils.$win.trigger("validationErrorDisplay", [
                                b,
                                d,
                            ]),
                                d.html(c);
                    ...
                    if (f)
                        a.formUtils.warn(
                            "Using deprecated element reference " + f.id
                        ),
                            (g = a(f)),
                            i();
                    else if (
                        "function" == typeof d.inlineErrorMessageCallback
                    ) {
                        if (((g = d.inlineErrorMessageCallback(b, c, d)), !g))
                            return;
                        i();
                    } else {
            ...
            (a.fn.validateOnBlur = function (b, c) {
                ...
                (a.fn.validateInputOnBlur = function (c, d, e, f) {
                    ...
                    (c = a.extend({}, a.formUtils.LANG, c || {})),
                        a.formUtils.dialogs.removeInputStylingAndMessage(
                            this,
                            d
                        );
                    var i = this,
                    ...
                    return (
                        ...
                        k.shouldChangeDisplay &&
                            (k.isValid
                                ? a.formUtils.dialogs.applyInputSuccessStyling(
                                      i,
                                      d
                                  )
                ...
                (a.fn.isValid = function (b, c, d) {
                    ...
                    var f = function (b, e) {
                            a.inArray(b, h) < 0 && h.push(b),
                                ...
                                d &&
                                    a.formUtils.dialogs.applyInputErrorStyling(
                                        e,
                                        c
                                    );
                        },
                    ...
                    if (
                        (d &&
                            a.formUtils.dialogs.removeAllMessagesAndStyling(
                                j,
                                c
                            ),
                        j
                            ...
                            .each(function () {
                                ...
                                if (!k(i, e) && (!h || a.inArray(i, g) < 0)) {
                                    h && g.push(i);
                                    var l = a.formUtils.validateInput(
                                        d,
                                        b,
                                        c,
                                        j,
                        ...
                        !a.formUtils.haltValidation && i.length > 0
                            ? (d &&
                                  ("top" === c.errorMessagePosition
                                      ? a.formUtils.dialogs.setMessageInTopOfForm(
                                            j,
                                            h,
                                            c,
                                            b
                ...
                loadModules: function (b, c, d) {
                    ...
                    if (c) f(b, c);
                        ...
                        var g = function () {
                            var c = !1;
                            return (
                                a('script[src*="form-validator"]').each(
                                    function () {
                                        return (
                                            (c =
                                                this.src.substr(
        ...
        (function (a) {
            ...
            (a.split = function (b, c) {
                ...
                (a.validate = function (b) {
                    ...
                    if (
                        ((b = a.extend(c, b || {})), b.lang && "en" !== b.lang)
                    ) {
                    ...
                    a(b.form).each(function (c, d) {
                        ...
                        e.trigger("formValidationSetup", [e, b]),
                            ...
                            b.validateOnBlur &&
                                ...
                                e.bind(
                                    "html5ValidationAttrsFound",
                                    function () {
                                        e.validateOnBlur(b.language, b);
                                    }
                                )),
                            b.validateOnEvent &&
                                e.validateOnEvent(b.language, b);
                    }),
                        "" !== b.modules &&
                            a.formUtils.loadModules(b.modules, !1, function () {
                                "function" == typeof b.onModulesLoaded &&
                                    b.onModulesLoaded();
                                var c =
                                    "string" == typeof b.form
                                        ? a(b.form)
                                        : b.form;
                                a.formUtils.$win.trigger("validatorsLoaded", [
                                    c,
                                    b,
                                ]);
                            });
            ...
            a.formUtils = a.extend(a.formUtils || {}, {
                ...
                defaultConfig: function () {
                    return {
                        ...
                        errorMessageTemplate: {
                            ...
                            messages:
                                "<strong>{errorTitle}</strong><ul>{fields}</ul>",
                            field: "<li>{msg}</li>",
                        },
                ...
                validateInput: function (b, c, d, e, f) {
                    ...
                    if (!j || i || b.valAttr("skipped"))
                        return (
                            (m.shouldChangeDisplay = d.addValidClassOnAll), m
                        );
                            ...
                            function (h) {
                                ...
                                return (
                                    ...
                                    k
                                        ? void 0
                                        : ((l =
                                              a.formUtils.dialogs.resolveErrorMessage(
                                                  b,
                                                  i,
                                                  h,
                                                  d,
                ...
                numericRangeCheck: function (b, c) {
                    ...
                    return (
                        1 === d.length &&
                            ...
                            (d = [c, c]),
                        2 === d.length &&
                        (b < parseInt(d[0], 10) || b > parseInt(d[1], 10))
                            ? ["out", d[0], d[1]]
                            : 0 === c.indexOf("min") && e > b
                            ? ["min", e]
                            : 0 === c.indexOf("max") && b > e
                ...
                validatorFunction: function (b) {
                    ...
                    if (d && e) {
                        if (0 === d.indexOf('"')) {
                            var f = d.length;
                            if (
                                ((d = d.replace(/\"/g, "")), d.length !== f - 2)
                            )
                                return !1;
                        }
                        return (
                            a.formUtils.validators.validate_domain.validatorFunction(
                                c[1]
                            ) &&
                            0 !== d.indexOf(".") &&
                ...
                a.formUtils.addValidator({
                    ...
                    validatorFunction: function (b, c, d, e) {
                        ...
                        switch (j[0]) {
                            case "out":
                                (this.errorMessage =
                                    e.lengthBadStart + f + e.lengthBadEnd),
                                    (h = !1);
                                break;
                            case "min":
                                (this.errorMessage =
                                    e.lengthTooShortStart +
                                    j[1] +
                                    e.lengthBadEnd),
                                    (h = !1);
                                break;
                    ...
                    validatorFunction: function (b, c, d, e) {
                        ...
                        if (h) {
                            ...
                            j.indexOf(" ") > -1 &&
                                ((j = j.replace(" ", "")),
                                (j +=
                                    e.andSpaces || a.formUtils.LANG.andSpaces)),
                                (this.errorMessage =
                                    e.badAlphaNumeric +
                                    e.badAlphaNumericExtra +
                                    j);
                        } else
                            (i = f + g),
