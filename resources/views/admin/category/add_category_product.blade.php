                ...
                <div class="panel-body">
                    ...
                    <div class="position-center">
                        ...
                        <div class="form-group">
                            ...
                            <textarea style="resize: none" rows="4" class="form-control" name="category_product_desc" id="exampleInputdesc" placeholder="Mô tả danh mục"></textarea>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputdesc">Từ khóa danh mục</label>
                            <textarea style="resize: none" rows="4" class="form-control" name="category_product_keywords" id="exampleInputdesc" placeholder="Mô tả danh mục"></textarea>
                        </div>
                        <div class="form-group">
                        ...
                        <button type="submit" name="add_caegory_product" class="btn btn-info">Thêm danh mục</button>
                    </form>
                    </div>
