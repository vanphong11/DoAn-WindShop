                    ...
                    <div class="bill-to">
                        ...
                        <div class="form-one ">
                            ...
                            <form >
                                ...
                                <input type="button" value="Xác nhận" name="send_order" class="btn btn-primary btn-sm calculate_delivery " >
                            </form>
                            ...
                            <form  method="POST">
                                ...
                                <input type="button" value="Xác nhận đơn hàng" name="send_order" class="btn btn-primary btn-sm send-order" >
                            </form>
